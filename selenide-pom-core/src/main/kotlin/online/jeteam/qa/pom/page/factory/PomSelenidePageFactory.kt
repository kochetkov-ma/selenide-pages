...
import online.jeteam.qa.pom.page.factory.PomAnnotations.Companion.builder
import online.jeteam.qa.pom.page.factory.PomAnnotations.Companion.javaPageFactoryFinderAnnotation
import online.jeteam.qa.pom.page.factory.PomAnnotations.Companion.ktPageFactoryFinderAnnotations
...
open class PomSelenidePageFactory : SelenidePageFactory() {
    ...
    override fun decorate(
        ...
        when {
            field.isSelfElementsContainer -> if (searchContext != null && !field.isAnnotationPresent(NotPom::class.java))
    ...
    override fun findSelector(driver: Driver, field: Field): By =
        ...
        else PomAnnotations(field).buildBy()
    ...
    internal companion object PomSelenidePageFactoryUtil {
        internal val INSTANCE = PomSelenidePageFactory()
